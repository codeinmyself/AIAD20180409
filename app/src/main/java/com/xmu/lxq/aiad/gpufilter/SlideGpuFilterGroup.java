package com.xmu.lxq.aiad.gpufilter;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(AppContext.getContext());
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                locked = true;
                downX = -1;
                if (offset > AppContext.screenWidth / 3) {
                    scroller.startScroll(offset, 0, AppContext.screenWidth - offset, 0, 100 * (1 - offset / AppContext.screenWidth));
                    needSwitch = true;
                } else {
                    scroller.startScroll(offset, 0, -offset, 0, 100 * (offset / AppContext.screenWidth));
                    needSwitch = false;
                }
                break;
        }
