...
public class MagicHefeFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(AppContext.getContext(), "filter/edgeburn.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(AppContext.getContext(), "filter/hefemap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(AppContext.getContext(), "filter/hefemetal.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(AppContext.getContext(), "filter/hefesoftlight.png");
		    }
	    });
	}
}
